...
namespace Core.Utilities.Resluts
{
    public class Result : IResult
    {
        ...
        public Result(bool success, string message):this(success)//redonlyler constructor içinde set edilebilir. :this(success) yapmamızın sebebi 16.satırında çalısmasını sağlamak için.Yani alttaki resultı tetiklemek.
